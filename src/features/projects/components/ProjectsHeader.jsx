...
export const ProjectsHeader = ({ 
  ...
  const navButtons = [
    ...
    { id: 'team_matrix', label: 'Matriz de Equipo', icon: Target },
    { id: 'alerts_center', label: 'Centro de Actividad', icon: Bell },
    { id: 'reports_center', label: 'Reportes', icon: FileText },
    { id: 'developer', label: 'Mi Trabajo', icon: Code },
  ];

  return (
    <div className="space-y-4">
      {/* Fila superior: Saludo y Filtro de proyectos */}
