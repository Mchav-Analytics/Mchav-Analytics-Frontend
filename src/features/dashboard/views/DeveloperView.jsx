...
export default function DeveloperView({ kpis = [], selectedProjectId = 'PROJ-01', onNavigateToAlerts }) {
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden space-y-10 py-4 text-left font-sans min-h-[85vh] flex flex-col justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-1">
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-3">
                ...
                <span className="flex items-center gap-2 rounded-full bg-emerald-50 dark:bg-emerald-500/10 px-3.5 py-1 text-xs font-semibold text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20">
      ...
      {isPending && (
        <div className="relative rounded-2xl bg-amber-50 dark:bg-slate-900 p-6 shadow-sm dark:shadow-xl border border-amber-300 dark:border-amber-500/30">
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              <div className="p-3.5 bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-xl shrink-0 border border-amber-500/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xs font-bold text-slate-800 dark:text-white uppercase tracking-wider">Cycle Time</h3>
              </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
              ...
              <span className="font-semibold text-emerald-600 dark:text-emerald-400">{scorecard?.cycle_time_prev || 3.5}d</span>
            </div>
          </div>
        </div>
        ...
        <div className="group relative flex flex-col rounded-2xl bg-white dark:bg-[#191c3d] p-7 shadow-sm dark:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-slate-200 dark:border-[#33376b] min-h-[220px] justify-between">
          <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
              <span className="text-slate-500 dark:text-slate-400">Capacidad Máx: {scorecard?.wip_max || 10}</span>
              <span className="font-semibold text-purple-600 dark:text-purple-400">Avg {scorecard?.wip_avg || 5.5}</span>
            </div>
          </div>
        </div>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xs font-bold text-slate-800 dark:text-white uppercase tracking-wider">Throughput</h3>
              </div>
          ...
          <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xs font-bold text-slate-800 dark:text-white uppercase tracking-wider">Story Points</h3>
              </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
              <span className="text-slate-500 dark:text-slate-400">Meta: {scorecard?.story_points_target || 80} SP</span>
              <span className="font-semibold text-indigo-600 dark:text-indigo-400">{scorecard?.story_points_achieved_pct || 81}% Completado</span>
            </div>
          </div>
        </div>
