...
export default function LiderTecnicoDashboardView({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 relative text-slate-900 dark:text-slate-100">
      ...
      {/* ── CABECERA UNIFICADA DE CONTROL OPERATIVO ── */}
      <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white shadow-sm dark:shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-indigo-50 dark:bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30 flex items-center gap-1.5">
              <ShieldCheck size={13} className="text-indigo-600 dark:text-indigo-400" />
              Liderazgo Técnico
            </span>
            <span className="text-xs text-slate-500 dark:text-slate-400">• Proyecto: <strong className="text-slate-900 dark:text-slate-200 font-semibold">{selectedProjectId || 'SCRUM'}</strong></span>
          </div>
          <h1 className="text-xl md:text-2xl font-bold tracking-tight">
            Centro de Control Operativo del Sprint Activo
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 text-xs font-semibold shadow-xs transition-all flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-md transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
          >
            <FileDown size={14} /> 
