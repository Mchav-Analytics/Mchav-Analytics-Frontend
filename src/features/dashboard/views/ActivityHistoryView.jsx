    ...
    <div className="w-full space-y-10 py-4 px-1 text-left font-sans min-h-[85vh] flex flex-col justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-1">
              <h1 className="text-2xl font-bold text-white flex items-center gap-3">
                ...
                <span className="flex items-center gap-2 rounded-full bg-purple-500/10 px-3.5 py-1 text-xs font-semibold text-purple-400 border border-purple-500/20">
      ...
      <div className="space-y-5">
        <h2 className="text-sm font-extrabold text-slate-400 uppercase tracking-wider flex items-center gap-2">
          <Award size={18} className="text-purple-400" /> Mis Logros y Medallas de Desempeño
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">

          {/* Badge 1 */}
          <div className="group relative flex flex-col rounded-2xl bg-slate-950 p-7 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-emerald-500/20 border border-slate-800/80 justify-between min-h-[190px]">
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div className="space-y-1">
                <h3 className="text-base font-bold text-white">{badges[0]?.title || "Zero Defect Delivery"}</h3>
                <p className="text-xs text-slate-400 leading-relaxed">{badges[0]?.description || "2 Sprints consecutivos completados sin re-apertura de bugs en QA."}</p>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-bold text-emerald-400 border border-emerald-500/20 mt-4">
          ...
          {/* Badge 2 */}
          <div className="group relative flex flex-col rounded-2xl bg-slate-950 p-7 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-indigo-500/20 border border-slate-800/80 justify-between min-h-[190px]">
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div className="space-y-1">
                <h3 className="text-base font-bold text-white">{badges[1]?.title || "Fast Delivery Hero"}</h3>
                <p className="text-xs text-slate-400 leading-relaxed">{badges[1]?.description || "Cycle Time menor a 2.5 días en tickets de 5 Story Points."}</p>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/10 px-3 py-1 text-xs font-bold text-indigo-400 border border-indigo-500/20 mt-4">
                  ⚡ Medalla Desbloqueada
                </span>
              </div>
            </div>
          ...
          {/* Badge 3 */}
          <div className="group relative flex flex-col rounded-2xl bg-slate-950 p-7 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-amber-500/20 border border-slate-800/80 justify-between min-h-[190px]">
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div className="space-y-1">
                <h3 className="text-base font-bold text-white">{badges[2]?.title || "Sprint Master"}</h3>
                <p className="text-xs text-slate-400 leading-relaxed">{badges[2]?.description || "Cumplimiento del 81% de Story Points comprometidos en Sprint 2."}</p>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/10 px-3 py-1 text-xs font-bold text-amber-400 border border-amber-500/20 mt-4">
                  🎯 Medalla Desbloqueada
                </span>
              </div>
            </div>
      ...
      <div className="group relative flex flex-col rounded-2xl bg-slate-950 p-8 shadow-2xl border border-slate-800/80 transition-all duration-300 flex-1 justify-between">
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-base font-bold text-white uppercase tracking-wider flex items-center gap-2">
              <Calendar size={18} className="text-indigo-400" /> Timeline de Actividades Recientes (Para Standups)
            </h2>
            <span className="text-xs text-slate-400 font-semibold">Últimos 7 días</span>
          </div>

          <div className="space-y-4">
            {activityFeed.map((item, idx) => (
              <div key={idx} className="flex items-start gap-5 p-4 bg-slate-900/60 border border-slate-800/80 rounded-xl hover:border-slate-700 transition-colors">
