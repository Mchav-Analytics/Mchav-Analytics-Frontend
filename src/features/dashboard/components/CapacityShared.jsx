...
export const InfoTooltip = ({ text, align = "center" }) => {
  return (
    <span className="group/tooltip relative inline-flex items-center cursor-help ml-1 shrink-0 z-30">
      <span className="p-0.5 rounded-full text-slate-400 hover:text-indigo-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer inline-flex items-center">
        <Info size={13} />
      </span>
      <span className={`absolute bottom-full mb-2 ${align === "right" ? "right-0" : align === "left" ? "left-0" : "left-1/2 -translate-x-1/2"} hidden group-hover/tooltip:block w-60 p-2.5 bg-slate-900/95 dark:bg-slate-950/95 text-slate-100 text-[11px] font-normal leading-relaxed rounded-xl shadow-2xl z-50 pointer-events-none text-left backdrop-blur-md border border-slate-700/80`}>
        {text}
        <span className={`absolute top-full ${align === "right" ? "right-3" : align === "left" ? "left-3" : "left-1/2 -translate-x-1/2"} border-4 border-transparent border-t-slate-900 dark:border-t-slate-950`}></span>
      </span>
    </span>
  );
};
...
export const REAL_JIRA_ISSUES_DB = [
  ...
  { key: 'SCRUM-1', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Tarea 1: Estructuración inicial de repositorio y módulos base', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Felipe Alcalá', sp: 1, priority: 'Media', type: 'Tarea' },
  ...
  { key: 'SCRUM-3', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Tarea 3: Implementación de componentes de UI y navegación', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Camilo Corredor', sp: 1, priority: 'Media', type: 'Tarea' },
  ...
  { key: 'SCRUM-5', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Creación del repositorio donde guardan los artefactos', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Michael Salamanca', sp: 1, priority: 'Media', type: 'Tarea' },
  ...
  { key: 'SCRUM-7', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Investigación de la aplicación Jira y mapeo de estados', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Felipe Alcalá', sp: 1, priority: 'Media', type: 'Tarea' },
  ...
  { key: 'SCRUM-9', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Pruebas de recuperación de información de la API de Jira', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Camilo Corredor', sp: 1, priority: 'Media', type: 'Tarea' },
  { key: 'SCRUM-15', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Documento Visión del Proyecto Analytics y KPIs', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Camilo Corredor', sp: 2, priority: 'Media', type: 'Tarea' },
  { key: 'SCRUM-16', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Documento de requerimientos funcionales y de seguridad', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Felipe Alcalá', sp: 3, priority: 'Alta', type: 'Tarea' },
  ...
  { key: 'SCRUM-24', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Diagrama de modelo de datos en PostgreSQL/SQLite', status: 'Completados', rawStatus: 'Finalizado', assignee: 'Michael Salamanca', sp: 1, priority: 'Media', type: 'Tarea' },
  { key: 'SCRUM-104', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Implementar autenticación OAuth 2.0 con Atlassian Jira Cloud', status: 'En Progreso', rawStatus: 'En curso', assignee: 'Valentina Montalvo', sp: 5, priority: 'Alta', type: 'Historia' },
  { key: 'SCRUM-112', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Crear endpoints REST para sincronización periódica de sprints', status: 'En Progreso', rawStatus: 'En curso', assignee: 'Camilo Corredor', sp: 3, priority: 'Media', type: 'Tarea' },
  { key: 'SCRUM-145', project: 'MCHAV ANALITYCS', projectId: '10000', summary: 'Configuración de alertas automáticas para incidencias bloqueadas', status: 'Por Hacer', rawStatus: 'Por hacer', assignee: 'Stephany León', sp: 2, priority: 'Alta', type: 'Tarea' },
  ...
  { key: 'PA-76', project: 'Prueba ASD', projectId: '10033', summary: 'Diseñar interfaz web de métricas de rendimiento', status: 'En Revisión', rawStatus: 'Listo', assignee: 'Felipe Alcalá', sp: 5, priority: 'Media', type: 'Tarea' },
  { key: 'PA-77', project: 'Prueba ASD', projectId: '10033', summary: 'Configurar autenticación OAuth 2.0 con Atlassian Console', status: 'En Revisión', rawStatus: 'Listo', assignee: 'Felipe Alcalá', sp: 8, priority: 'Alta', type: 'Tarea' },
  ...
  { key: 'PA-79', project: 'Prueba ASD', projectId: '10033', summary: 'Implementar exportador de reportes en PDF y formato impreso', status: 'En Revisión', rawStatus: 'Listo', assignee: 'Michael Salamanca', sp: 5, priority: 'Alta', type: 'Tarea' },
  ...
  { key: 'PA-82', project: 'Prueba ASD', projectId: '10033', summary: 'Refactorizar controladores siguiendo Clean Architecture', status: 'En Revisión', rawStatus: 'Listo', assignee: 'Michael Salamanca', sp: 3, priority: 'Media', type: 'Tarea' },
  { key: 'PA-84', project: 'Prueba ASD', projectId: '10033', summary: 'Corregir bug de token en refresco de sesión', status: 'En Revisión', rawStatus: 'Listo', assignee: 'Felipe Alcalá', sp: 2, priority: 'Alta', type: 'Tarea' },
