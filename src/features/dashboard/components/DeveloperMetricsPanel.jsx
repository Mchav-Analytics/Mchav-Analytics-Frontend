...
export default function DeveloperMetricsPanel({ scorecard }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {/* CYCLE TIME DEV */}
      <div className="flex flex-col rounded-3xl bg-white dark:bg-[#141738] p-5 shadow-sm border border-emerald-200 dark:border-emerald-500/30 justify-between transition-all duration-300 hover:shadow-md hover:shadow-emerald-500/10 min-h-[160px] relative group overflow-visible">
      ...
      {/* TICKETS WIP */}
      <div className="flex flex-col rounded-3xl bg-white dark:bg-[#141738] p-5 shadow-sm border border-purple-200 dark:border-purple-500/30 justify-between transition-all duration-300 hover:shadow-md hover:shadow-purple-500/10 min-h-[160px] relative group overflow-visible">
      ...
      {/* THROUGHPUT DEV */}
      <div className="flex flex-col rounded-3xl bg-white dark:bg-[#141738] p-5 shadow-sm border border-cyan-200 dark:border-cyan-500/30 justify-between transition-all duration-300 hover:shadow-md hover:shadow-cyan-500/10 min-h-[160px] relative group overflow-visible">
      ...
      {/* VOLUMEN (SP) */}
      <div className="flex flex-col rounded-3xl bg-white dark:bg-[#141738] p-5 shadow-sm border border-indigo-200 dark:border-indigo-500/30 justify-between transition-all duration-300 hover:shadow-md hover:shadow-indigo-500/10 min-h-[160px] relative group overflow-visible">
