        ...
        <div className="flex flex-col gap-2.5 mt-2">
          {criticalBugsList.length > 0 ? (
            criticalBugsList.map(b => (
              <button 
                key={b.key} 
                onClick={() => onSelectIssue && onSelectIssue(b)}
                className="w-full text-left flex items-start gap-2.5 text-[11px] text-rose-850 dark:text-slate-300 bg-rose-500/10 hover:bg-rose-500/15 dark:hover:bg-rose-500/20 px-3.5 py-2.5 rounded-xl border border-rose-500/20 shadow-inner transition-all cursor-pointer focus:outline-none focus:ring-1 focus:ring-rose-500"
              >
          ...
          {blockedList.length > 0 ? (
            blockedList.map(b => (
              <button 
                key={b.key} 
                onClick={() => onSelectIssue && onSelectIssue(b)}
                className="w-full text-left flex items-start gap-2.5 text-[11px] text-amber-850 dark:text-slate-300 bg-amber-500/10 hover:bg-amber-500/15 dark:hover:bg-amber-500/20 px-3.5 py-2.5 rounded-xl border border-amber-500/20 shadow-inner transition-all cursor-pointer focus:outline-none focus:ring-1 focus:ring-amber-500"
              >
